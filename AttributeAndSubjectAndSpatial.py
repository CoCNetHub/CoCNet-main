        ...
        for file in files:
            ...
            for subFile in subFileDir:
                ...
                for i in range(len(data)):
                    ...
                    print(j, i, j / (i + 1))
                    pre = j / (i + 1)
                    path = "/root/autodl-tmp/result/attributeandsubjectandspatial/" + file + "_attributeandsubjectandspatial_adjust_" + clip_model_list_item + '' + annotationFileName
                    fo = open(path, "a")
                    fo.write(str(queries) + ',' + str(flag) + ',' + str(pre) + "\n")

                attribute_result_path = "/root/autodl-tmp/result/attributeandsubjectandspatial/"+"attributeandsubjectandspatial_adjust1_"+clip_model_list_item+".csv"
