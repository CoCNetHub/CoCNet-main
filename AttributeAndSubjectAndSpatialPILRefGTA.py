        ...
        for file in files:
            ...
            for subFile in subFileDir:
                ...
                for i in range(len(data)):
                    ...
                    path = "/root/autodl-tmp/result/attributeandsubjectandspatial/" + file + "_attributeandsubjectandspatial_" + clip_model_list_item_str + '' + annotationFileName
                    fo = open(path, "a")
                    fo.write(str(queries) + ',' + str(flag) + ',' + str(pre) + "\n")

                attribute_result_path = "/root/autodl-tmp/result/attributeandsubjectandspatial/"+"attributeandsubjectandspatial_"+clip_model_list_item_str+".csv"
